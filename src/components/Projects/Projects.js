...
import Vibify from "../../Assets/Projects/vibify.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Vibify"
              description="Vibify is the ultimate music player for every mood, inspired by popular music player app 'Spotify'.Enjoy seamless playback, choose favourite artists and experience high-quality audio with an advanced audio equalizer, And many more options like play/pause, next and previous songs.Enjoy your vibe with vibify."
